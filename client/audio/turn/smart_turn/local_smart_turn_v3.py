...
Copied from pipecat-ai/pipecat with import adjustments for NOVA.
"""
...
from client.audio.turn.smart_turn.base_smart_turn import BaseSmartTurn
...
class LocalSmartTurnAnalyzerV3(BaseSmartTurn):
    ...
    def __init__(
        ...
        self._log_data = _env_truthy("PIPECAT_SMART_TURN_LOG_DATA", default=False)

        if not smart_turn_model_path:
            smart_turn_model_path = str(
                Path(__file__).parent / "data" / "smart-turn-v3.2-cpu.onnx"
            )
